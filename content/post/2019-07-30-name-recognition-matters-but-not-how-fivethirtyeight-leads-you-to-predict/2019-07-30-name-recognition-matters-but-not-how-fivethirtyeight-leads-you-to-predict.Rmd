...
```{r, warning = FALSE, message = FALSE, echo = FALSE, fig.cap = "The ribbons represents [95% confidence intervals](https://rpsychologist.com/d3/CI/) around the predictions."}
...
```{r, warning = FALSE, message = FALSE, echo = FALSE, fig.cap = "The ribbons represents [95% confidence intervals](https://rpsychologist.com/d3/CI/) around the predictions. The vote share data are a little different from those presented by FiveThirtyEight because our sources were likely different."}
