...
## Data
> I took the data from Table 3.1 in Mackinnon (2008, p. 56) [[**.csv**](/post/2019-02-13-testing-indirect-effects-mediation-in-r/2019-02-13-testing-indirect-effects-mediation-in-r_files/mackinnon_2008_t10.1.csv)]
...
mediate(consume ~ room_temp + thirst, data = thirst_dat, n.iter = 10000) %>% 
  print(short = FALSE)
