...
thirst_norm <- read_csv("data/mackinnon_2008_t3.1.csv")
thirst_fit <- read_csv("data/mackinnon_2008_t10.1.csv")
...
thirst_data <- thirst_data %>% 
  mutate(room_temp_c = room_temp - mean(room_temp),
...
thirst_data %>% 
  write_csv(path = "data/thirst_data.csv")
