...
> This post builds on a previous post on Testing Indirect Effects/Mediation in R [[**.html**](https://nickmichalak.netlify.com/post/2019-02-13-testing-indirect-effects-mediation-in-r/testing-indirect-effects-mediation-in-r/)].
...
## Data
> I combined the data from Table 3.1 in Mackinnon (2008, p. 56) [[**.csv**](![](post/2019-02-14-testing-conditional-indirect-effects-mediation-in-r/2019-02-14-testing-conditional-indirect-effects-mediation-in-r_files/data/mackinnon_2008_t3.1.csv))] with those from Table 10.1 in Mackinnon (2008, p. 291) [[**.csv**](post/2019-02-14-testing-conditional-indirect-effects-mediation-in-r/2019-02-14-testing-conditional-indirect-effects-mediation-in-r_files/data/mackinnon_2008_t10.1.csv)]

```{r, message = FALSE, warning = FALSE}

thirst_norm <- "data/mackinnon_2008_t3.1.csv" %>% read_csv()
...
## Conceptual Diagram
![Figure 1. Focus on which association fitness group could moderate. Here, the association between room temperature and thirstiness depends on fitness group.](![](/2019-02-14-testing-conditional-indirect-effects-mediation-in-r/2019-02-14-testing-conditional-indirect-effects-mediation-in-r_files/figure_01.jpeg)) 
...
## Conceptual Diagram
![Figure 2. Focus on which association fitness group could moderate. Here, the association between thirstiness and water drinking depends on fitness group.](![](/2019-02-14-testing-conditional-indirect-effects-mediation-in-r/2019-02-14-testing-conditional-indirect-effects-mediation-in-r_files/figure_02.jpeg))
